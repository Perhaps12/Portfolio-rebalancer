        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Avoid unescaped dollar signs in plain prose, avoid writing math immediately adjacent to surrounding text, and prefer simple inline math or plain text when a formula is not essential. "
